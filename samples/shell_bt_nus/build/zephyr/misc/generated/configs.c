...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_Z_VDB_SIZE, 8);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NRF_BPROT_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_PINE64_PINETIME_KEY_OUT_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RX_STACK_SIZE, 1536);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_PERIPHERAL_COUNT, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_BT_NUS_RX_RING_BUFFER_SIZE, 32);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_COLOR_DEPTH_1, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_COLOR_DEPTH, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_MEM_BUF_MAX_NUM, 24);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_MEMCPY_MEMSET_STD, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_Z_MEM_POOL_NUMBER_BLOCKS, 12);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_Z_BUFFER_ALLOC_DYNAMIC, 1);
