...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MAX_CONN, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_NUS_CLIENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_NUS_CLIENT_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_NUS_CLIENT_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MAX_PAIRED, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_BT_NUS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_BT_NUS_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_BT_NUS_LOG_LEVEL, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_BT_NUS_LOG_MESSAGE_QUEUE_TIMEOUT, 100);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_BT_NUS_LOG_MESSAGE_QUEUE_SIZE, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_BT_NUS_INIT_LOG_LEVEL_WRN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_BT_NUS_INIT_LOG_LEVEL, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_BT_NUS_TX_RING_BUFFER_SIZE, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_BT_NUS_RX_RING_BUFFER_SIZE, 50);
