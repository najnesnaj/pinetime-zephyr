...
#endif
//#define BMA421_REG_PMU_RANGE            0x41 //todo
//#define BMA421_REG_PMU_BW		0x40 //bma421 has 1 register for ODR and BW
//#define BMA421_PMU_BW		0x0E //default 500Hz todo choice list Kconfig
...
#if CONFIG_BMA421_PMU_BW_1
	#define BMA421_PMU_BW		0x08
#elif CONFIG_BMA421_PMU_BW_2
	#define BMA421_PMU_BW		0x09
#elif CONFIG_BMA421_PMU_BW_3
	#define BMA421_PMU_BW		0x0A
#elif CONFIG_BMA421_PMU_BW_4
	#define BMA421_PMU_BW		0x0B
#elif CONFIG_BMA421_PMU_BW_5
	#define BMA421_PMU_BW		0x0C
#elif CONFIG_BMA421_PMU_BW_6
	#define BMA421_PMU_BW		0x0D
#elif CONFIG_BMA421_PMU_BW_7
	#define BMA421_PMU_BW		0x0E
#elif CONFIG_BMA421_PMU_BW_8
	#define BMA421_PMU_BW		0x0F
#endif
...
#define BMA421_PMU_RANGE	0x00 //default 2G todo choice menu for 421


#define BMA421_REG_PMU_RANGE		0x0F
#if CONFIG_BMA421_PMU_RANGE_2G
	#define BMA421_PMU_RANGE	0x03
	#define BMA421_PMU_FULL_RANGE	(4 * SENSOR_G)
#elif CONFIG_BMA421_PMU_RANGE_4G
	#define BMA421_PMU_RANGE	0x05
	#define BMA421_PMU_FULL_RANGE	(8 * SENSOR_G)
#elif CONFIG_BMA421_PMU_RANGE_8G
	#define BMA421_PMU_RANGE	0x08
	#define BMA421_PMU_FULL_RANGE	(16 * SENSOR_G)
#elif CONFIG_BMA421_PMU_RANGE_16G
	#define BMA421_PMU_RANGE	0x0C
	#define BMA421_PMU_FULL_RANGE	(32 * SENSOR_G)
#endif
