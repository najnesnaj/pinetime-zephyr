...
{
	calendar1.tm_year = cts->year -1900;
	calendar1.tm_mon = cts->month -1;
	calendar1.tm_mday = cts->day;
	calendar1.tm_hour = cts->hours;
	calendar1.tm_min = cts->minutes;
	calendar1.tm_sec = cts->seconds;
//	mktime(&calendar1);
