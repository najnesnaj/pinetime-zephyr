...
UUID should be different from the cts
    """
    CURRENT_TIME_UUID = '1806'
...
class CurrentTimeCharacteristic(Characteristic):
    """
The systemtime is increased with 5 minutes

This should be replaced with an xml-file containing multiple dates
    """
    ...
    def current_time_bytes(self):
        ...
        value.append(dbus.Byte(dt.tm_min+5))
