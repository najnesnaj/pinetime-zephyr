...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_HOR_RES_MAX, 240);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_VER_RES_MAX, 240);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_VDB_SIZE, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_BITS_PER_PIXEL, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_DPI, 128);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_KSCAN2, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_KSCAN_FT9999, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_KSCAN_FT9999_PERIOD, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_KSCANR2_INIT_PRIORITY, 40);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ST7789V_RGB565, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_COLOR_DEPTH_16, 1);
