...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_HOR_RES_MAX, 128);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_VER_RES_MAX, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_VDB_SIZE, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_BITS_PER_PIXEL, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_COLOR_DEPTH_1, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_USE_API_EXTENSION_V6, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_USE_API_EXTENSION_V7, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_BACKEND_RTT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_PROMPT_RTT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_RTT_RX_POLL_PERIOD, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_BACKEND_RTT_LOG_MESSAGE_QUEUE_TIMEOUT, 100);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_BACKEND_RTT_LOG_MESSAGE_QUEUE_SIZE, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_RTT_INIT_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_RTT_INIT_LOG_LEVEL, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_RTT_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_RTT_LOG_LEVEL, 3);
