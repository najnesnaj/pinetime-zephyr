		...
		const enum display_pixel_format pixel_format)
{
	...
	{ u8_t tmp; st7789v_set_lcd_margins(p_st7789v, 0, 0); st7789v_transmit(p_st7789v, ST7789V_CMD_PORCTRL, st7789v_porch_param,
...
#if (defined(DT_INST_0_SITRONIX_ST7789V_VRHS) && defined(DT_INST_0_SITRONIX_ST7789V_VDVS))
